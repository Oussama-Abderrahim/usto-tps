...
public class PaintPanel extends JPanel
{
    ...
    private JPanel initColorPanel(int width, int height)
    {
        ...
        for (int i = 0; i < colorButtons.length; i++)
        {
            ...
            colorButtons[i].addActionListener(e ->
            {
                ...
                this.socketPeerConnection.send(new adivina.events.PaintEvent(adivina.events.PaintEvent.PaintEventType.COLOR_CHANGE, index));
            });
    ...
    private void setupMouseListeners()
    {
        ...
        canvasPanel.addMouseMotionListener(new MouseMotionListener()
        {
            ...
            {
                onDrag(e.getPoint());
                socketPeerConnection.send(new adivina.events.PaintEvent(adivina.events.PaintEvent.PaintEventType.DRAG, e.getPoint()));
            }
        ...
        canvasPanel.addMouseListener(new MouseListener()
        {
            ...
            {
                onPress(e.getPoint());
                socketPeerConnection.send(new adivina.events.PaintEvent(adivina.events.PaintEvent.PaintEventType.PRESSED, e.getPoint()));
            }
            ...
            public void mouseReleased(MouseEvent e)
            {
                ...
                socketPeerConnection.send(new adivina.events.PaintEvent(adivina.events.PaintEvent.PaintEventType.RELEASED, e.getPoint()));
            }
    ...
    public void clear()
    {
        if (this.socketPeerConnection != null)
            socketPeerConnection.send(new adivina.events.PaintEvent(adivina.events.PaintEvent.PaintEventType.CLEAR, null));
