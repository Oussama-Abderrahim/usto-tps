...
public class RelationnalMapReduce {
    ...
    public static class Reduce
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            {
                result.set(result.toString() + key + "(" + tuple +") ");
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: exo7.RelationnalMapReduce <in> <out>");
            System.exit(2);
        }

        // create a job with name "exo7.RelationnalMapReduce"
        final String JOB_NAME = RelationnalMapReduce.class.getSimpleName();
        Job job = new Job(conf, JOB_NAME);
        job.setJarByClass(RelationnalMapReduce.class);
